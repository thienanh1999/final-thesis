# Generated by Django 3.2.8 on 2021-11-16 17:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotated_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cell', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='api.cell')),
                ('claim', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.claim')),
                ('sentence', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='api.sentence')),
            ],
            options={
                'db_table': 'evidence',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='api.cell')),
                ('claim', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.claim')),
                ('document', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='api.document')),
                ('sentence', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='api.sentence')),
            ],
            options={
                'db_table': 'annotator',
